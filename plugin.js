...
const {router_connector_ST} = require('./lib/smartthings/smartthings-connector.js');
//const {router_connector_ST, formatEvent4ST, formatDevice4ST} = require('./lib/smartthings/smartthings-connector.js');
...
smartthingsHome.prototype.didFinishLaunching = function() {
  ...
  app.use('/smartthings', router_connector_ST); // integration with SmartThings
