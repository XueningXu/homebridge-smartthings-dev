var debug = require('debug')('smartthings:Homebridge');
...
Homebridge.prototype.toSmartThings = function(opt) {
  var list = [];

  // smartthings devices made up of multiple homekit accessories in a single homebridge instance
  // Devices include Apple TV and Yamaha Stereo Playback controls

  // xuening: do not consider playback device
  /*
  ...
  */
  ...
  for (var index in this.accessories) {
    ...
    var smartthings = accessory.toSmartThings({
      deviceID: this.deviceID,
