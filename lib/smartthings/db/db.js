...
const Database = {
  ...
  createTables: function() {
    ...
    // create Devices table (device_id, attributes)
  ...
  async addAccount(username, password) {
    await this.db.get('SELECT * FROM Acounts WHERE username=?', username, (err, row) => {
  ...
  // insert ifttt-exposed devices to database
  // [
